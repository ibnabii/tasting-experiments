...
from .views import PanelView, render_qr_code, SampleSetsView, SamplePreparationView, UpdatePanelStatusView
...
urlpatterns = [
    ...
    path('<pk>/status/<status>', UpdatePanelStatusView.as_view(), name='panel-update-status'),
]